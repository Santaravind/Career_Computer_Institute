...
const courses = [
  {
    id: 1,
    name: "Post Diploma in Computer Hardware Maintenance",
    duration: "1 Year",
  },
  ...
  {
    id: 5,
    name: "Diploma in Computer Hardware Maintenance and Network Engineering",
    duration: "1 Year",
  },
  ...
  {
    id: 9,
    name: "Certificate in Mobile Phone Technology",
    duration: "3 Months",
  },
  ...
  {
    id: 19,
    name: "Diploma in Global Hardware and Networking",
    duration: "1 Year",
  },
  {
    id: 20,
  ...
  {
    id: 28,
    name: "Certificate in Clerical Jobs in Computerised Office",
    duration: "3 Months",
  },
  {
    id: 29,
    name: "Certificate in Operations of Computer in Retail Shops",
    duration: "3 Months",
  },
  {
    id: 30,
    name: "Certificate in Data Entry and Console Operation",
    duration: "2 Months",
  },
  {
    id: 31,
  ...
  {
    id: 48,
    name: "Honors Diploma in Multimedia Programming",
    duration: "1 Year",
  },
  {
    id: 49,
    name: "Advanced Diploma in Multimedia Programming",
    duration: "6 Months",
  },
  {
    id: 50,
    name: "Honors Diploma in Computer Application",
    duration: "6 Months",
  },
  {
    id: 51,
    name: "Diploma in Laptop Hardware & Wifi Technology",
    duration: "6 Months",
  },
  { id: 52, name: "Tally ERP 9", duration: "3 Months" },
  {
    id: 53,
    name: "Honors Diploma in Computer Hardware & Networking",
    duration: "6 Months",
  },
  {
    id: 54,
  ...
  {
    id: 71,
    name: "Certificate in Computer Python Programming",
    duration: "3 Months",
  },
  ...
  {
    id: 74,
    name: "Advanced Diploma in Animation Design and Technology",
    duration: "1 Year",
  },
  {
    id: 75,
    name: "Diploma in Visual Design & Communication",
    duration: "1 Year",
  },
  ...
  {
    id: 78,
    name: "Advanced Diploma in 3D Printing Technology",
    duration: "1 Year",
  },
  {
    id: 79,
    name: "Certificate Course in 3D Printing Technology",
    duration: "6 Months",
  },
  {
    id: 80,
    name: "Diploma in User Interface and User Experience (UI/UX)",
    duration: "1 Year",
  },
  { id: 81, name: "Diploma in Visual Effects", duration: "1 Year" },
  {
    id: 82,
    name: "Diploma in Graphic Web Designing & Development",
    duration: "1 Year",
  },
];
function Computer() {
  ...
  return (
    <>
      <div className="bg-gray-50 py-9 px-6">
        ...
        <h1 className="text-6xl font-bold text-center mb-2  text-[#0B56A4]  p-3">
          Our Courses
        </h1>
        <div className="w-34 h-2 bg-linear-to-r from-purple-400 to-pink-400 mx-auto rounded-full mb-6 "></div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          {displayedCourses.map((course, index) => (
            <div
              ...
              className="flex flex-col items-center cursor-pointer justify-center border border-gray-300 rounded-xl bg-white p-6 shadow-[0_20px_50px_rgba(8,112,184,0.7)] hover:shadow-[inset_1px_15px_13px_0px_#48bb78] transition"
            >
              {/* Icon */}
